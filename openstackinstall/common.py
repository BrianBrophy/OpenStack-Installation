...
def install_glance(databaseUserPassword, mySQLIP, mySQLPassword, controlNodeIP):
  ...
  set_config_ini(glanceApiConf, 'DEFAULT', 'connection', "mysql://glance:%s@%s/glance" %(databaseUserPassword,mySQLIP))
  ...
  set_config_ini(glanceRegistryConf, 'DEFAULT', 'connection', "mysql://glance:%s@%s/glance" %(databaseUserPassword,mySQLIP))
