...
def base_system_update():
  ...
  osicommon.delete_file("/etc/apt/sources.list.d/icehouse.list")
  osicommon.run_command("echo deb http://ubuntu-cloud.archive.canonical.com/ubuntu precise-updates/icehouse main >> /etc/apt/sources.list.d/icehouse.list")
  osicommon.run_command("apt-get update -y", True)
  osicommon.run_command("apt-get dist-upgrade -y", True)
  osicommon.run_command("apt-get install -y linux-image-generic-lts-saucy linux-headers-generic-lts-saucy", True)
#######################################################################
...
def install_cinder(databaseUserPassword, controlNodeIP, mySQLPassword):
  ...
  #osicommon.delete_file('/etc/apt/sources.list.d/icehouse-iscsitarget.list')
  #osicommon.run_command("echo deb http://ppa.launchpad.net/smb/iscsitarget/ubuntu precise main >> /etc/apt/sources.list.d/icehouse-iscsitarget.list")
  #osicommon.run_command("echo deb-src http://ppa.launchpad.net/smb/iscsitarget/ubuntu precise main >> /etc/apt/sources.list.d/icehouse-iscsitarget.list")
  ...
  osicommon.set_config_ini(cinderConf, 'keystone_authtoken', 'auth_uri', "http://%s:5000" %controlNodeIP)
  osicommon.set_config_ini(cinderConf, 'keystone_authtoken', 'auth_host', controlNodeIP)
  osicommon.set_config_ini(cinderConf, 'keystone_authtoken', 'auth_port', '35357')
  osicommon.set_config_ini(cinderConf, 'keystone_authtoken', 'auth_protocol', 'http')
...
def install_glance(databaseUserPassword, controlNodeIP, mySQLPassword):
  ...
  osicommon.set_config_ini(glanceApiConf, 'keystone_authtoken', 'auth_host', controlNodeIP)
  osicommon.set_config_ini(glanceApiConf, 'keystone_authtoken', 'auth_uri', "http://%s:5000" %controlNodeIP)
  osicommon.set_config_ini(glanceApiConf, 'keystone_authtoken', 'auth_port', '35357')
  osicommon.set_config_ini(glanceApiConf, 'keystone_authtoken', 'auth_protocol', 'http')
  ...
  osicommon.set_config_ini(glanceRegistryConf, 'keystone_authtoken', 'auth_host', controlNodeIP)
  osicommon.set_config_ini(glanceRegistryConf, 'keystone_authtoken', 'auth_uri', "http://%s:5000" %controlNodeIP)
  osicommon.set_config_ini(glanceRegistryConf, 'keystone_authtoken', 'auth_port', '35357')
  osicommon.set_config_ini(glanceRegistryConf, 'keystone_authtoken', 'auth_protocol', 'http')
...
def install_mysql(rootPassword):
  ...
  ourConfigFile = os.path.join(os.path.dirname(__file__), '../icehouse.mysql.my.cnf')
...
def install_neutron_on_compute_node(databaseUserPassword, controlNodeIP, computeNodeInstanceIP):
  ...
  osicommon.set_config_ini(neutronConf, 'keystone_authtoken', 'auth_uri', "http://" + controlNodeIP + ":5000")
  osicommon.set_config_ini(neutronConf, 'keystone_authtoken', 'auth_host', controlNodeIP)
  osicommon.set_config_ini(neutronConf, 'keystone_authtoken', 'auth_protocol', 'http')
  osicommon.set_config_ini(neutronConf, 'keystone_authtoken', 'auth_port', '35357')
...
def install_neutron_on_control_node(databaseUserPassword, controlNodeIP, mySQLPassword):
  ...
  osicommon.set_config_ini(neutronConf, 'DEFAULT', 'nova_admin_auth_url', "http://" + controlNodeIP + ":5000/v2.0/")
...
def install_nova_on_compute_node(databaseUserPassword, controlNodeIP, computeNodeIP):
  ...
  osicommon.set_config_ini(novaConf, 'keystone_authtoken', 'auth_uri', "http://%s:5000" %controlNodeIP)
  osicommon.set_config_ini(novaConf, 'keystone_authtoken', 'auth_host', controlNodeIP)
  osicommon.set_config_ini(novaConf, 'keystone_authtoken', 'auth_port', '35357')
  osicommon.set_config_ini(novaConf, 'keystone_authtoken', 'auth_protocol', 'http')
...
def install_nova_on_control_node(databaseUserPassword, controlNodeIP, mySQLPassword):
  ...
  osicommon.set_config_ini(novaConf, 'DEFAULT', 'linuxnet_interface_driver', 'nova.network.linux_net.LinuxOVSInterfaceDriver')
  osicommon.set_config_ini(novaConf, 'DEFAULT', 'security_group_api', 'neutron')
  osicommon.set_config_ini(novaConf, 'DEFAULT', 'service_neutron_metadata_proxy', 'True')
  osicommon.set_config_ini(novaConf, 'DEFAULT', 'neutron_metadata_proxy_shared_secret', 'helloOpenStack')
  osicommon.set_config_ini(novaConf, 'DEFAULT', 'iscsi_helper', 'tgtadm')
  osicommon.set_config_ini(novaConf, 'DEFAULT', 'volume_name_template', 'volume-%s')
  osicommon.set_config_ini(novaConf, 'DEFAULT', 'volume_group', 'cinder-volumes')
  osicommon.set_config_ini(novaConf, 'DEFAULT', 'iscsi_ip_address', controlNodeIP)
